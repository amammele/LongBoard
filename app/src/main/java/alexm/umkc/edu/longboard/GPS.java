...
public class GPS extends Activity implements GPSCallback{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gps_speed);
    ...
    private void updateCount() {
        TextView s = (TextView) findViewById(R.id.SpeedValueView);
        s.setText(Double.toString(speed));
        TextView b = (TextView) findViewById(R.id.LongitudeValueView);
        b.setText(Double.toString(longitude));
        TextView t = (TextView) findViewById(R.id.LatitudeValueView);
        t.setText(Double.toString(latitude));
    }
